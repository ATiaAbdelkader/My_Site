    ...
    card.innerHTML = `
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1 min-w-0">
          ...
          <button onclick="copyCitation('${p.title}', '${p.journal}', ${p.year}, '${p.doi}')" class="inline-flex items-center gap-1 text-amber-400 text-xs font-medium hover:text-amber-300 transition-colors mt-1"><i data-lucide="quote" style="width:12px;height:12px"></i> نسخ الاقتباس</button>
        </div>
  ...
  container.innerHTML = `
    <div class="glass-card rounded-2xl p-6 mb-8 overflow-hidden">
      <div class="text-center mb-4">
        <h3 class="text-white font-bold text-lg">🗺️ خريطة المؤتمرات</h3>
        <p class="text-gray-500 text-xs">البصمة الجغرافية للمشاركات الدولية</p>
      </div>
      <div class="relative" style="max-width:600px;margin:0 auto;aspect-ratio:1.5;">
        ...
        <div style="position:absolute;top:42%;left:48%;"><div class="w-3 h-3 rounded-full bg-cyan-400 shadow-lg" style="box-shadow:0 0 10px #22d3ee;"></div><span class="text-[8px] text-cyan-400 absolute -bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap">تونس</span></div>
        <div style="position:absolute;top:38%;left:45%;"><div class="w-3 h-3 rounded-full bg-amber-400 shadow-lg" style="box-shadow:0 0 10px #fbbf24;"></div><span class="text-[8px] text-amber-400 absolute -bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap">الجزائر</span></div>
        <div style="position:absolute;top:35%;left:40%;"><div class="w-3 h-3 rounded-full bg-cyan-400 shadow-lg" style="box-shadow:0 0 10px #22d3ee;"></div><span class="text-[8px] text-cyan-400 absolute -bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap">مراكش</span></div>
        <div style="position:absolute;top:44%;left:44%;"><div class="w-3 h-3 rounded-full bg-amber-400 shadow-lg" style="box-shadow:0 0 10px #fbbf24;"></div><span class="text-[8px] text-amber-400 absolute -bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap">ورقلة</span></div>
        <div style="position:absolute;top:42%;left:46%;"><div class="w-3 h-3 rounded-full bg-cyan-400 shadow-lg" style="box-shadow:0 0 10px #22d3ee;"></div><span class="text-[8px] text-cyan-400 absolute -bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap">بسكرة</span></div>
        <div style="position:absolute;top:43%;left:47%;"><div class="w-3 h-3 rounded-full bg-amber-400 shadow-lg" style="box-shadow:0 0 10px #fbbf24;"></div><span class="text-[8px] text-amber-400 absolute -bottom-3 left-1/2 -translate-x-1/2 whitespace-nowrap">الوادي</span></div>
      </div>
...
function copyCitation(title, journal, year, doi) {
  ...
  navigator.clipboard.writeText(apa).then(() => {
    showToast('📋 تم نسخ الاقتباس!', 'success');
  }).catch(() => {
    showToast('📋 ' + apa, 'info');
  });
}
